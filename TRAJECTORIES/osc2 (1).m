...
T=1.0; %FUCK THIS
nSamples=640+1; %controls our time
r=0.35*T/4; % DSP
...
% A_bal=[0.0,3.0,15.0];
A_move=[25,0.0,35.0]; %WALK with hands % Amplitude of movement oscillator of feet
A_bal=[0.0,10.5,10.0]; % amplitude balance oscilltor % y is multiplied by 7 in packets
