function [f00,f01,f02,f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f11,f12,f13,f14,f15,f16,f17,f18,f19,f20,fle,fre] = FK_T3_1(LL,RL,LH,RH,NY,NP,DIP,COM_POS)
...
f_chest=f_com*T(0,0,142.241);                            %position of chest

f11=f_chest*T(0,59.34,0)*RY(t11);                        %left chest to neck
f12=f11*T(0,33,0)*RX(t12);                               %left neck to shoulder 
f13=f12*T(0,0,-90.54)*RX(t13);                           %left shoulder to elbow
f14=f13*T(0,0,-96.70);                                   %left elbow to wrist      %this


f15=f_chest*T(0,-59.34,0)*RY(t14);                       %right chest to neck
f16=f15*T(0,-33,0)*RX(t15);                              %right neck to shoulder 
f17=f16*T(0,0,-90.54)*RX(t16);                           %right shoulder to elbow
f18=f17*T(0,0,-96.70);                                   %right elbow to wrist   %this

f19=f_chest*T(0,0,12)*RZ(NY);
f20=f19*T(0,0,15)*RY(-NP);
f02=f20*T(0,0,40);                                        %head centre
