function [ output_args ] = PLOT_T3_1(f00,f01,f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f11,f12,f13,f14,f15,f16,f17,f18,fle,fre,DISP_FRAMES)
%3D plot Nino T3.1 
...
%plotting base frame
plot3([-100,600],[0,0],[0,0],'k','linewidth',0.5);
